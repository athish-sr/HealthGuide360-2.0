...
with open("disease\\common_disease_data.json",'r') as f:
    old_disease_data=json.load(f)    
f.close()

data=pd.read_csv("disease\\common_diseases.csv", encoding='ISO-8859-1')
...
rf_classifier=joblib.load('disease\\common_disease_diagnoser.pkl')
